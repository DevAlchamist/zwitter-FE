...
import { fetchUserByIdAsync, selectUserDetails } from "../user/userSlice";
import {
  fetchPostByIdAsync,
...
const Profile = () => {
  // const user = useSelector(selectLog);
  ...
  // if (userPosts && userPosts.likedIds) {
  ...
  useEffect(() => {
    if (userPosts && params.id) {
      ...
      userPosts.forEach((post) => {
        const userHasLiked =
        post.likedIds && post.likedIds.includes(params.id);
          ...
          <div className="">
            <div className="">
              <div className=" flex justify-start">
                ...
                <div className="mx-2">
                  <h2 className="mb-0 text-xl font-bold ">{userInfo.name}</h2>
              ...
              <div className="p-4">
                <div className="relative flex w-full">
                  ...
                  <div className="flex flex-col text-right">
                    <button className="justify-center  max-h-max whitespace-nowrap focus:outline-none  focus:ring  rounded max-w-max border bg-transparent border-blue-500 text-blue-500 flex items-center hover:shadow-lg font-bold py-2 px-4 mr-0 ml-auto">
                      Edit Profile
                    </button>
                  </div>
                </div>
